...
public class CustomerListAdapter extends RecyclerView.Adapter<CustomerListAdapter.ProgramViewHolder>  {
    ...
    public CustomerListAdapter(ArrayList<Integer> data1, ArrayList<String> data2, ArrayList<String> data3){
        this.data1 = data1;
        this.data2 = data2;
        this.data3 = data3;
    }
    ...
    public class ProgramViewHolder extends RecyclerView.ViewHolder{
        ...
        public ProgramViewHolder (View itemView){
            ...
            parentLayout = (RecyclerView)itemView.findViewById(R.id.customer_list);
        }
